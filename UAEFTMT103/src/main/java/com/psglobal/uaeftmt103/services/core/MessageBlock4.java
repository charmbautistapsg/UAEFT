...
public class MessageBlock4 {
    ...
    final LoanIQExtAtr loanIQExtAtr;

    MessageBlock4(MessageUtil messageUtil, UaeftMT130Configuration uaeftMT130Configuration, LoanIQExtAtr loanIQExtAtr) {
        this.messageUtil = messageUtil;
        this.uaeftMT130Configuration = uaeftMT130Configuration;
        this.loanIQExtAtr = loanIQExtAtr;
    }

    void constructBlock4(Set<PaymentMethodFormat> paymentMethodFormatList, MT103 mt103, Map<String, Object> loanIQMap) {
        ...
        if (field13C.isPresent() && !((String) field13C.get()).isEmpty()) {
            field13C.ifPresent(a -> mt103.addField(new Field13C((String) a)));
        }
        ...
        if (field20.isPresent() && !((String) field20.get()).isEmpty()) {
            field20.ifPresent(a -> mt103.addField(new Field20(messageUtil.convertLoanIQRIDToSwift((String) a))));
        }
        ...
        if (field21.isPresent() && !((String) field21.get()).isEmpty()) {
            field21.ifPresent(a -> mt103.addField(new Field21(messageUtil.convertLoanIQRIDToSwift((String) a))));
        }
        ...
        if (field23B.isPresent() && !((String) field23B.get()).isEmpty()) {
            field23B.ifPresent(a -> mt103.addField(new Field23B((String) a)));
        }
        ...
        if (field23E.isPresent() && !((String) field23E.get()).isEmpty()) {
            field23E.ifPresent(a -> mt103.addField(new Field23E((String) a)));
        }

        // this field is left blank until decision is made .
        //populateField26T(loanIQMap, mt103);
        ...
        if (field36.isPresent() && !((String) field36.get()).isEmpty()) {
            field36.ifPresent(a -> mt103.addField(new Field36(messageUtil.formatExchangeRate((String) field36.get()))));
        }
        ...
        if (account50A.isPresent() && identifier50A.isPresent())
            setAccountAndIdentifier(field50AObject, "com.prowidesoftware.swift.model.field.Field50A", mt103);
        ...
        if (nameAndAddressLine50K.isPresent() && identifier50A.isEmpty())
            setAccountNameAndAddress(field50KObject, "com.prowidesoftware.swift.model.field.Field50K", mt103);
        ...
        if (account51A.isPresent() && identifier51A.isPresent())
            setAccountAndIdentifier(field51AObject, "com.prowidesoftware.swift.model.field.Field51A", mt103);
        ...
        if (account52A.isPresent() && identifier52A.isPresent())
            setAccountAndIdentifier(field52AObject, "com.prowidesoftware.swift.model.field.Field52A", mt103);
        ...
        if (nameAndAddressLine52D.isPresent() && identifier52A.isEmpty())
            setAccountNameAndAddress(field52DObject, "com.prowidesoftware.swift.model.field.Field52D", mt103);
        ...
        if (account53A.isPresent() && identifier53A.isPresent())
            setAccountAndIdentifier(field53AObject, "com.prowidesoftware.swift.model.field.Field53A", mt103);
        ...
        if (nameAndAddressLine53D.isPresent() && identifier53A.isEmpty())
            setAccountNameAndAddress(field53DObject, "com.prowidesoftware.swift.model.field.Field53D", mt103);
        ...
        if (nameAndAddressLine53D.isEmpty() && identifier53A.isEmpty() && account53B.isPresent())
            setAccountOnly(field53BObject, "com.prowidesoftware.swift.model.field.Field53B", mt103);
        ...
        if (account54A.isPresent() && identifier54A.isPresent())
            setAccountAndIdentifier(field54AObject, "com.prowidesoftware.swift.model.field.Field54A", mt103);
        ...
        if (nameAndAddressLine54D.isPresent() && identifier54A.isEmpty())
            setAccountNameAndAddress(field54DObject, "com.prowidesoftware.swift.model.field.Field54D", mt103);
        ...
        if (nameAndAddressLine54D.isEmpty() && identifier54A.isEmpty() && account54B.isPresent())
            setAccountOnly(field54BObject, "com.prowidesoftware.swift.model.field.Field54B", mt103);
        ...
        if (account56A.isPresent() && identifier56A.isPresent())
            setAccountAndIdentifier(field56AObject, "com.prowidesoftware.swift.model.field.Field56A", mt103);
        ...
        if (nameAndAddressLine56D.isPresent() && identifier56A.isEmpty())
            setAccountNameAndAddress(field56DObject, "com.prowidesoftware.swift.model.field.Field56D", mt103);
        ...
        if (account56C.isPresent() && identifier56A.isEmpty() && nameAndAddressLine56D.isEmpty())
            setAccountOnly(field56CObject, "com.prowidesoftware.swift.model.field.Field56C", mt103);
        ...
        if (identifier57A.isPresent() && account57A.isPresent()) {
            setAccountAndIdentifier(field57AObject, "com.prowidesoftware.swift.model.field.Field57A", mt103);
        }
        ...
        if (identifier57A.isEmpty() && nameAndAddressLine57D.isPresent()) {
            setAccountNameAndAddress(field57DObject, "com.prowidesoftware.swift.model.field.Field57D", mt103);
        }
        ...
        if (account57C.isPresent() && nameAndAddressLine57D.isEmpty() && identifier57A.isEmpty()) {
            setAccountOnly(field57CObject, "com.prowidesoftware.swift.model.field.Field57C", mt103);
        }
        ...
        if (account59A.isPresent() && identifier59A.isPresent())
            setAccountAndIdentifier(field59AObject, "com.prowidesoftware.swift.model.field.Field59A", mt103);
        ...
        if (nameAndAddressLine59.isPresent() && identifier59A.isEmpty())
            setAccountNameAndAddress(field59Object, "com.prowidesoftware.swift.model.field.Field59", mt103);
        ...
        if (field71A.isPresent() && !((String) field71A.get()).isEmpty()) {
            field71A.ifPresent(a -> mt103.addField(new Field71A((String) a)));
        }
        ...
        if (field72Object.isPresent()) {
            ...
            if (senderToReceiverInfo.isPresent() && isNotNullNotEmpty(((String[]) senderToReceiverInfo.get())[0])) {
                ...
                mt103.addField(field72);
            }
        }
        populateField77B(loanIQMap, mt103);

    }

    private void setAccountOnly(Optional<?> fieldObject, String fieldClasPath, MT103 mt103) {
        try {
    ...
    private void setAccountNameAndAddress(Optional<?> fieldObject, String fieldClasPath, MT103 mt103) {
        try {
            Optional<?> account = getFieldValueFromMap(fieldObject, "account");
    ...
    private void setAccountAndIdentifier(Optional<?> fieldObject, String fieldClasPath, MT103 mt103) {
        try {
            Optional<?> account = getFieldValueFromMap(fieldObject, "account");
    ...
    public Optional<?> setNameAndAddressLine(Optional<?> nameAndAddressLine) {
        if (nameAndAddressLine.isPresent()) {
            return Optional.ofNullable(MessageUtil.getFixedLengthStrings((String) nameAndAddressLine.get(), uaeftMT130Configuration.getLength()));
        }
    ...
    private void populateField26T(Map<String, Object> loanIQMap, MT103 mt103) {
        ...
        if (str26TValue != null && str26TValue.length() >= 3) {
            ...
            mt103.addField(new Field26T(str26TValue));
        }
    }

    private void populateField77B(Map<String, Object> loanIQMap, MT103 mt103) {
        String strOwnerType = (String) loanIQMap.get("imt_cde_owner_type");
        String strOwnerId = (String) loanIQMap.get("imt_rid_owner");
        ...
        if (str77BValue != null && str77BValue.length() >= 3) {
            ...
            mt103.addField(new Field77B(str77BValue));
        }
    }
